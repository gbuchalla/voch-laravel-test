...
return [
    ...
    | várias versões, como as regras de tamanho. Fique à vontade para 
    ...
    */
    ...
    | para atributos usando a convenção "attribute.rule" para nomear as linhas.
    |
    */
    ...
    |----------------------------------------------------------------------
    |
    | Aqui você pode substituir os nomes dos atributos para algo mais 
    | amigável ao leitor, como "Endereço de E-Mail" em vez de "email".
    |
    */
